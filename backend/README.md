...
## Project Structure
    ...
    ├── testapiautostoryboa_95271  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_95271`
...
2. Clone this repo and `cd testapiautostoryboa_95271`
